...
const MediaCaptureValidation = () => {
  ...
  const handleVideoRecord = () => {
    ...
    setVideoRecorded(!videoRecorded);
  };
  ...
  const handleAllowEntry = () => {
    const allPhotosRequired = Object.values(capturedPhotos).every(v => v);
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                {photoCards.map((card) => (
                  <button
                    ...
                    className={`relative rounded-xl p-8 border-2 transition-all hover:shadow-md group ${
              ...
              <div className="mb-8">
                ...
                <button
                  ...
                  className={`w-full relative rounded-xl p-8 border-2 transition-all hover:shadow-md group ${
                    videoRecorded
                      ? 'bg-gradient-to-br from-green-50 to-green-100 border-green-300'
                      : 'bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 hover:border-blue-400'
                  }`}
                >
                  <div className="flex items-center gap-6">
                    {/* Video Icon */}
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center transition-all flex-shrink-0 ${
                      videoRecorded
                        ? 'bg-green-500 scale-110'
                        : 'bg-white group-hover:scale-110'
                    }`}>
