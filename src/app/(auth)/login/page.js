...
//         <h1 className="text-2xl font-bold text-center mb-2">ANPR Sentinel</h1>
...
//           © {new Date().getFullYear()} ANPR Sentinel
//         </p>
//       </div>
//     </div>
//   );
...
//         <h1 className="text-2xl font-bold text-center mb-1">ANPR Login</h1>
//         <p className="text-center text-gray-500 mb-6">
...
//           © {new Date().getFullYear()} ANPR System
//         </p>
//       </div>
//     </div>
//   );
